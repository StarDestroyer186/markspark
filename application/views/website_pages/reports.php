                        ...
                        <div class="row gy-4">
                                ...
                                <div class="categories">
                                    ...
                                    <ul class="cat_list">
                                        ...
                                        <!-- <li>
                                            <a href="#">
                                                <div class="cat_icon">
                                                    <img src="<?php //echo base_url('website-assets/images/logo.png'); ?>assets/images/icons/cat-icon-2.svg" alt="">
                                                </div>
                                                <p>Agriculture</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <div class="cat_icon">
                                                    <img src="<?php //echo base_url('website-assets/images/logo.png'); ?>assets/images/icons/cat-icon-3.svg" alt="">
                                                </div>
                            ...
                            <p>2034 <b>Industry Research Report</b></p>
                                <div class="reports_list">
                                    <?php 
                                        if(!empty($reportcategorieslistweb)) {
                                              foreach($reportcategorieslistweb as $row) {
                                    ...
                                    <!-- <div class="reportlist_item">
                                        <h5>Quartz Glass Market</h5>
                                        <a href="reports-details.php" class="custom_btn">View details<i class="ri-arrow-right-s-line"></i></a>
                                    </div>
                                    <div class="reportlist_item">
                                        <h5>Quartz Glass Market</h5>
                                        <a href="reports-details.php" class="custom_btn">View details<i class="ri-arrow-right-s-line"></i></a>
